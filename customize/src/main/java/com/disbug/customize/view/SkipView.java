package com.disbug.customize.view;
...
public class SkipView extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            circleSolidColor = typedArray.getColor(R.styleable.SkipView_circleSolidColor, Color.GRAY);
            ...
            progressWidth = typedArray.getInt(R.styleable.SkipView_progressWidth, 5);
            textSize = typedArray.getInt(R.styleable.SkipView_textSize, 40);
            textPadding = typedArray.getInt(R.styleable.SkipView_textPadding, 10);
